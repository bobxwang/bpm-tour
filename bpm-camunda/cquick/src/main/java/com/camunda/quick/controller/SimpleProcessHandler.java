...
import com.camunda.quick.dto.PscCommonProcessRequest;
import com.camunda.quick.dto.PscCommonTaskRequest;
...
public interface SimpleProcessHandler {
    ...
    List<TaskDto> simpleInitProcess(@RequestBody PscCommonProcessRequest pscCommonProcessRequest) throws Exception;

    @ApiOperation(value = "流程提交", notes = "流程提交")
    @RequestMapping(value = "/simpleStartProcess", method = RequestMethod.POST)
    List<TaskDto> simpleStartProcess(@RequestBody PscCommonProcessRequest pscCommonProcessRequest, HttpServletRequest request) throws Exception;
    ...
    List<HistoricTaskInstance> simpleGetHisTasks(
    ...
    List<TaskDto> simpleGetTaskIds(
            @ApiParam(name = "processDefKey", value = "流程定义Key", required = true) @PathVariable String processDefKey)
            throws Exception;

    @ApiOperation(value = "流程审批", notes = "流程审批")
    @RequestMapping(value = "/simpleApproveProcess", method = RequestMethod.POST)
    List<TaskDto> simpleApproveProcess(@RequestBody PscCommonTaskRequest pscCommonTaskRequest, HttpServletRequest request) throws Exception;

    @ApiOperation(value = "流程撤回", notes = "流程撤回")
    @RequestMapping(value = "/simpleUndoProcess", method = RequestMethod.POST)
    List<TaskDto> simpleUndoProcess(@RequestBody PscCommonTaskRequest pscCommonTaskRequest, HttpServletRequest request) throws Exception;
    ...
    List<TaskDto> simpleRollbackProcess(@RequestBody PscCommonTaskRequest pscCommonTaskRequest, HttpServletRequest request) throws Exception;
    ...
    List<TaskDto> simpleTerminateProcess(@RequestBody PscCommonTaskRequest pscCommonTaskRequest, HttpServletRequest request) throws Exception;
    ...
    List<TaskDto> simpleRestartProcess(@RequestBody PscCommonTaskRequest pscCommonTaskRequest, HttpServletRequest request) throws Exception;

    @ApiOperation(value = "流程转办", notes = "流程转办，将当期任务转交给其他人处理")
    @RequestMapping(value = "/simpleTurnOverProcess", method = RequestMethod.POST)
    List<TaskDto> simpleTurnOverProcess(@RequestBody PscCommonTaskRequest pscCommonTaskRequest, HttpServletRequest request) throws Exception;

    @ApiOperation(value = "流程跳转", notes = "流程跳转，跳转类型,1:往前跳转，2：往回跳转")
    @RequestMapping(value = "/simpleJumpProcess", method = RequestMethod.POST)
    List<TaskDto> simpleJumpProcess(@RequestBody PscCommonTaskRequest pscCommonTaskRequest, HttpServletRequest request) throws Exception;
